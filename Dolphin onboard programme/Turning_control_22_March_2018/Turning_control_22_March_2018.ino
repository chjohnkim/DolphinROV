...
float Set_Desire_depth = 40.0; //unit : cm
float Forward_thrust = 0;
float Max_Forward_thrust = 0;

//Speed Ramping

float Accele_run_Time = 0;
float Accele_Max_Time = 10;  // unit : sec


//Turning

float Turning_gain = 15; // unit : sec / rev
float Turning_con_switch = 1 ; // 1: ON , 0: OFF

//Set Experiment duration
unsigned long Start_Time = 0;
unsigned long End_Time = 0;
unsigned long Exper_Duration = 120; // Unit : second
