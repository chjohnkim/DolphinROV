...
double xDerivativeGain = 3.0; // Derivative Gain Constant
double yDerivativeGain = 3.0;
double zDerivativeGain = 3.0;
...
float Depth_con_qRef2 = -0.2;     //Pitch
float Depth_con_qRef3 = 0.0;
float Depth_con_qRef4 = 0.0;
float Depth_con_tilt_up = 0.2;
float Depth_con_tilt_down = -0.2;
float Depth_con_tilt_max = 0.2;
float Depth_con_tilt_gain = 0.05;
float Thrust_gain = 0.5;
float Depth_thrust_gain = 0.5 ;
float Depth_recv_gain = 1.0;
float Desire_depth = 1000.0;
float Desire_depth_range = 2.0; // unit : mm
float Current_depth = 1000.0;  // unit : mm
float Set_Desire_depth = 5.0; //unit : cm

//Set Experiment duration
unsigned long Start_Time = 0;
unsigned long End_Time = 0;
unsigned long Exper_Duration = 75; // Unit : second
